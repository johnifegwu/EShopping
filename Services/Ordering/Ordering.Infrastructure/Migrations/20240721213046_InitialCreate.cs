        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    is_paid = table.Column<bool>(type: "bit", nullable: true, defaultValue: false),
                    payment_reference = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    payment_provider_used = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    is_deleted = table.Column<bool>(type: "bit", nullable: true, defaultValue: false),
                    is_canceled = table.Column<bool>(type: "bit", nullable: true, defaultValue: false),
                    is_shipped = table.Column<bool>(type: "bit", nullable: true, defaultValue: false),
